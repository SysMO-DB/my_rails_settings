= my_rails_setting Gem
This is the Gem version of rails-setting Plugin

More information about the Plugin please see below, or at https://github.com/SysMO-DB/my_rails_settings

== Install
Put this line into Gemfile:
  gem 'my_rails_settings', :git => "git://github.com/SysMO-DB/my_rails_settings.git"

== Notice
Even through the plugin document below states that you can set the default value for certain setting, it doesn't work.
The Gem version fixes this problem.
...
Want a list of all the settings?
  ...
  Settings.to_hash            # returns {'admin_password' => 'super_secret', 'date_format' => '%m %d, %Y'}
...
You need name spaces and want a list of settings for a give name space? Just choose your prefered named space delimiter and use Settings.all like this:
  ...
  Settings.to_hash('preferences.')   # returns { 'preferences.color' => :blue, 'preferences.size' => :large }
...
Then you can set/get a setting for a given user instance just by doing this:
  ...
  user.settings.to_hash # { "color" => :red }
